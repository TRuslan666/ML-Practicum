...
# Настройки
# =====================================================================================
TRAIN_IMAGES_DIR = Path("dataset/processed/train/images")
TRAIN_LABELS_DIR = Path("dataset/processed/train/labels")
CLASSES_FILE = Path("dataset/processed/classes.txt")
